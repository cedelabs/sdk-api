...
import { Controller, Get, Query, Route, Tags, Response, Header } from 'tsoa';
...
export class ExchangeController extends Controller {
  ...
  public async fetchExchangeStatus(
    ...
    return await this.sdk.api.fetchExchangeStatus({ exchangeInstanceId, auth: { exchangeId, apiKey, secretKey, password, uid } });
  }
}
